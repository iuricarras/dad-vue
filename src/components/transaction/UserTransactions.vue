      ...
      <table class="w-full text-left border-collapse border border-gray-700 mb-4">
        <thead>
          <tr class="bg-gray-700">
            ...
            <th class="border border-gray-600 px-4 py-2">Game ID</th>
            <th class="border border-gray-600 px-4 py-2">Euros</th>
            <th class="border border-gray-600 px-4 py-2">Payment Type</th>
            <th class="border border-gray-600 px-4 py-2">Payment Reference</th>
            <th class="border border-gray-600 px-4 py-2">Brain Coins</th>
          </tr>
        </thead>
        <tbody>
          <tr
          ...
          >
            <td class="border border-gray-600 px-4 py-2 capitalize">
            ...
            <td class="border border-gray-600 px-4 py-2">{{ transaction.game_id || 'N/A' }}</td>
            <td class="border border-gray-600 px-4 py-2">
            ...
            <td class="border border-gray-600 px-4 py-2">{{ transaction.brain_coins }}</td>
          </tr>
        </tbody>
      </table>
