    ...
    <div>
        <div class="my-4 p-3 flex items-center bg-green-200 rounded-xl">
            <div class="grow flex-col">
                ...
                <p class="text-center text-lg">Player XX has won</p>
            </div>
            <button type="button"
                ...
                <span class="ps-2 text-base">Restart</span>
            </button>
        </div>
        <div class="grid grid-cols-4 grid-rows-3 border divide-x divide-y">
            <!-- Repeat the following Cell component 9 times -->
