...
<template>
  ...
  <!-- Conteúdo Principal -->
  <div class="relative flex flex-col lg:flex-row items-center justify-center mt-1 space-y-5 lg:space-y-0 lg:space-x-10">
    ...
    <div class="flex flex-col space-y-5 w-full lg:w-1/4">
      ...
      <RouterLink
        v-if="storeAuth.user && storeAuth.user.type !== 'A'"
        to="/multiplayer"
        class="block text-center hover:bg-gray-500 hover:shadow-lg transition"
      >
        <div class="bg-gray-600 text-white p-6 rounded w-full cursor-pointer">
          <div class="flex items-center justify-center space-x-2">
