...
<template>
  <div class="flex flex-col lg:flex-row items-center justify-center mt-1 space-y-5 lg:space-y-0 lg:space-x-10 fade-in">
      ...
      <RouterLink to="/multiplayer" class="block text-center">
        <div 
          ...
          <div class="flex items-center justify-center space-x-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 lg:w-8 lg:h-8">
              <path d="M16.5 12c2.485 0 4.5-2.015 4.5-4.5S18.985 3 16.5 3 12 5.015 12 7.5 14.015 12 16.5 12zM7.5 12c2.485 0 4.5-2.015 4.5-4.5S9.985 3 7.5 3 3 5.015 3 7.5 5.015 12 7.5 12zM7.5 14C4.467 14 0 15.285 0 18v3h15v-3c0-2.715-4.467-4-7.5-4zM16.5 14c-.251 0-.525.015-.815.04.972.754 1.815 1.747 1.815 2.96v3h6v-3c0-2.715-4.467-4-7.5-4z" />
            </svg>
          </div>
          <p class="text-sm lg:text-lg mt-2">Faz login para desbloquear este modo de jogo!</p>
        </div>
      </RouterLink>
