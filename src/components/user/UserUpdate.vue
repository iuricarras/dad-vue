...
<template>
  <Card v-show="storeAuth.user" class="w-[450px] mx-auto my-8 p-4 px-8 fade-in">
    ...
    <CardContent class="fade-in">
      ...
      <form>
        <div class="grid items-center w-full gap-4">
          ...
          <div class="drag-and-drop flex flex-col space-y-1.5 fade-in" @dragover.prevent @dragleave.prevent
            @drop.prevent="onDrop">
        ...
        <div class="flex flex-col space-y-4 fade-in">
          <div>
            ...
            <input id="password" type="password" placeholder="Write your password" v-model="credentials_delete.password"
              ...
              class="mt-1 block w-full px-3 py-2 bg-yellow-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm" />
            <ErrorMessage :errorMessage="storeError.fieldMessage('password')"></ErrorMessage>
          </div>
